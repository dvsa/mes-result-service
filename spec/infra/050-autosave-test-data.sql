CALL sp_create_retry_process_autosave(56, 'PROCESSING', NOW(), 'PROCESSING', 0, 'PROCESSING', 0);
CALL sp_create_retry_process_autosave(57, 'PROCESSING', NOW(), 'ACCEPTED', 0, 'PROCESSING', 0);
CALL sp_create_retry_process_autosave(58, 'PROCESSING', NOW(), 'PROCESSING', 0, 'ACCEPTED', 0);
CALL sp_create_retry_process_autosave(59, 'PROCESSING', NOW(), 'ACCEPTED', 0, 'ACCEPTED', 0);
